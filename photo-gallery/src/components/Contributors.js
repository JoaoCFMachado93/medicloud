      ...
      <div className="contributor">
        ...
        <div className="contributor-info">
          ...
          <p>
            ...
            Portuguese National Endoscopic Committee (SPEDY). During the early
      ...
      <div className="contributor">
        ...
        <div className="contributor-info">
          ...
          <p>
            ...
            aims to: Promote the development of digestive endoscopy in service
            to the health of the Portuguese population; Disseminate updated
            ideas, knowledge, and research in the field of digestive endoscopy;
            Stimulate research in digestive endoscopy; Promote national and
            international contacts and exchanges among various professionals
            involved in digestive endoscopy; Develop educational activities
            leading to the training and improvement of doctors and other
            technicians in digestive endoscopy; Contribute to the establishment
            of training and practice standards in digestive endoscopy. SPED is
            affiliated with the European Society of Gastrointestinal Endoscopy
